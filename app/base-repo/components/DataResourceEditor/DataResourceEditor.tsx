...
import {Terminal, Upload, Info, CircleSlash2} from "lucide-react";
            ...
            <div className="flex-grow ">
                <Tabs defaultValue="account" className="w-full">
                    <TabsList>
                        ...
                        <TabsTrigger value="content"><Icon fontSize={16} icon={"mdi:file-edit-outline"} className="h-4 w-4 mr-2"/> Edit Content</TabsTrigger>
                        <TabsTrigger value="metadata"><Icon fontSize={16} icon={"material-symbols-light:edit-square-outline"} className="h-4 w-4 mr-2"/>Edit Metadata</TabsTrigger>
                        ...
                        <Alert>
                            ...
                            <AlertDescription>
                                <span>Here you can upload new files to your resource. This is possible if you have WRITE
                                    ...
                                    from your local
                                    filesystem to the upload area below or click <Badge className={"text-info"} variant="outline">browse files</Badge> and select one
                        ...
                        {content && content.length > 0 ?
                            <>
                                ...
                                <span>Here you can edit and access existing content associated with your resource. You may add a tag via the <Badge
                                    ...
                                    which are smaller than 100 Kb. Active thumb images are marked with <Badge variant="thumb_set">Thumb</Badge>. If multiple files are marked as thumb, only the latest assignment will count.
                                </span>
                                        <br/><br/>
                            ...
                            <Alert>
                                ...
                                <AlertDescription>
                                <span>There was no content uploaded, yet. If you have WRITE permissions, you may switch to the <Badge variant="outline">
                    ...
                    <TabsContent value="metadata">
                        <Alert>
                            <Icon fontSize={16} icon={"material-symbols-light:edit-square-outline"} className="h-4 w-4 mr-2"/>
